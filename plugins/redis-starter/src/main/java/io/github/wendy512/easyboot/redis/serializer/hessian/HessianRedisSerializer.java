...
package io.github.wendy512.easyboot.redis.serializer.hessian;
 ...
 * @since 1.0.0
 */
public class HessianRedisSerializer<T> extends AbstractRedisCompressSerializer<T> {
    
    private Serializer serializer = SerializeSelector.select(SerializeType.HESSIAN);
