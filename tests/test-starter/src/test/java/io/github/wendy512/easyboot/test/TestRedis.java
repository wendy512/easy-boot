...
import io.github.wendy512.easyboot.redis.serializer.fastjson2.FastJson2RedisSerializer;
import io.github.wendy512.easyboot.redis.serializer.hessian.HessianRedisSerializer;
import io.github.wendy512.easyboot.redis.serializer.kryo.KryoRedisSerializer;
import io.github.wendy512.easyboot.redis.serializer.protostuff.ProtoStuffRedisSerializer;
...
public class TestRedis {
    ...
    private void doTestRedis(String templateName) {
        ...
        //json
        redisTemplate.setValueSerializer(new FastJson2RedisSerializer<>());
